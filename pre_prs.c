...
{
      10,     0,    -1,    -1,    10,    11,    -1,    12,    -1,    15,
      -1,     7,     3,    13,     4,    -1,    -1,    13,    14,    -1,
       6,     5,    -1,     8,     3,    16,     4,    -1,    -1,    16,
      17,    -1,     6,     6,     5,    -1
};
...
{
  "$end", "error", "$undefined", "l_bracket", "r_bracket", "semicolon",
  "quoted_str", "banks", "presets", "$accept", "cmds", "cmd", "bank_list",
  "bank_decls", "bank_decl", "pre_list", "pre_decls", "pre_decl", YY_NULL
};
#endif
...
{
       2,     0,     1,     0,     0,     3,     4,     5,     7,    11,
       0,     0,     6,     0,     8,    10,     0,    12,     9,     0,
      13
};
...
{
       0,    10,     0,     7,     8,    11,    12,    15,     3,     3,
      13,    16,     4,     6,    14,     4,     6,    17,     5,     6,
       5
};
...
#line 57 "pre_prs.y"
    {
		...
		appBank(pre_lnum, (yyvsp[(1) - (2)].str));
		free((yyvsp[(1) - (2)].str));
	}
    break;
...
#line 74 "pre_prs.y"
    {
		...
		appPre(pre_lnum, (yyvsp[(1) - (3)].str), (yyvsp[(2) - (3)].str));
		free((yyvsp[(1) - (3)].str));
		free((yyvsp[(2) - (3)].str));
	}
    break;
